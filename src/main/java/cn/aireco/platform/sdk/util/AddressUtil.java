...
public class AddressUtil {
    ...
    public static Map<String,String> addressResolution(String address){
        String regex="(?<province>[^特别行政区]+特别行政区|[^自治区]+自治区|[^省]+省|[^市]+市)(?<city>省直辖行政单位|省属虚拟市|市辖县|市辖区|县|自治州|[^地区]+地区|[^市]+市|[^州]+州|[^盟]+盟|[^区]+区|)?(?<county>[^旗]+旗|[^市]+市|[^县]+县|[^区]+区)?(?<town>[^县]+县|[^区]+区|[^乡]+乡|[^村]+村|[^镇]+镇|[^街道]+街道)?(?<village>.*)";
    ...
    public static void main(String[] args) {
        String str = "Hel21lo World231";
        String replacedStr = str.replaceAll("[a-zA-Z\\s]", "");
