...
import com.example.design.enums.GyConfig;

import java.security.MessageDigest;
import java.util.LinkedHashMap;

public class GySignUtil {

    public static String generateSign(JSONObject data) {
        String secret= GyConfig.secret;
    ...
    public static String generateSignByString(String str) {
        String secret=GyConfig.secret;
        StringBuilder enValue = new StringBuilder();
        enValue.append(secret);
        enValue.append(str);
